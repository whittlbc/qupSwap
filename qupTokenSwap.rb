...
sleep(2)
CLIENT_ID = "a4c78a955d9f43fa8e4387952f00e0b1"
CLIENT_SECRET = "34dd8e34b99241578c30affd33dc5e20"
CLIENT_CALLBACK_URL = "qup://mycallback"
AUTH_HEADER = "Basic " + Base64.strict_encode64(CLIENT_ID + ":" + CLIENT_SECRET)
SPOTIFY_ACCOUNTS_ENDPOINT = URI.parse("https://accounts.spotify.com")

set :port, 1235 # The port to bind to.
